...
<head>
    ...
    <link rel="stylesheet" href="../css/supervisor_check.css">
...
<body>
    <div class="container">
        ...
        <form action="supervisor_check.php?type=<?php echo $type; ?>" method="post">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $sql = "UPDATE $table_name SET supervisor_name='$supervisor_name' WHERE date='$date'";
